...
CREATE TABLE IF NOT EXISTS `mydb`.`fsm_floor` (
  ...
  `discriminator_column` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `mydb`.`fsm_user_attempt`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`fsm_user_attempt` ;

CREATE TABLE IF NOT EXISTS `mydb`.`fsm_user_attempt` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `attempts` INT(11) NOT NULL DEFAULT 0,
  `lastModified` DATETIME NOT NULL,
  `user_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_fsm_user_attempt_fsm_user1_idx` (`user_id` ASC),
  UNIQUE INDEX `user_id_UNIQUE` (`user_id` ASC),
  CONSTRAINT `fk_fsm_user_attempt_fsm_user1`
    FOREIGN KEY (`user_id`)
...
-- -----------------------------------------------------
-- Table `mydb`.`fsm_user_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`fsm_user_role` ;

CREATE TABLE IF NOT EXISTS `mydb`.`fsm_user_role` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_fsm_user_role_fsm_user1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_fsm_user_role_fsm_role1`
    FOREIGN KEY (`role_id`)
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`persistent_logins` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`persistent_logins` (
  ...
  PRIMARY KEY (`series`),
  INDEX `fk_persistent_logins_fsm_user1_idx` (`username` ASC),
  CONSTRAINT `fk_persistent_logins_fsm_user1`
    FOREIGN KEY (`username`)
    REFERENCES `mydb`.`fsm_user` (`username`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `mydb`.`fsm_employee`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
...
-- -----------------------------------------------------
-- Data for table `mydb`.`fsm_user`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`fsm_user` (`employee_id`, `username`, `password`) VALUES (1, 'Rkumarsingh', '$2a$10$z6h/RnKKdMg3Wwooivm5RO5G.MOiFgJrITtuffgeLIf2rqPmJB2wi');
INSERT INTO `mydb`.`fsm_user` (`employee_id`, `username`, `password`) VALUES (2, 'Pshama', '$2a$10$z6h/RnKKdMg3Wwooivm5RO5G.MOiFgJrITtuffgeLIf2rqPmJB2wi');

COMMIT;


-- -----------------------------------------------------
-- Data for table `mydb`.`fsm_role`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`fsm_role` (`role`) VALUES ('ROLE_ADMIN');
INSERT INTO `mydb`.`fsm_role` (`role`) VALUES ('ROLE_USER');

COMMIT;


-- -----------------------------------------------------
-- Data for table `mydb`.`fsm_user_role`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
